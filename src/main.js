...
app.innerHTML=`<div id="hud"><b>ParkourGame · прототип</b><div id="status">Загрузка…</div><small>WASD — движение · Shift — бег и захват края<br>Space — прыжок, повторно в воздухе — кувырок<br>W/Space в висе — подтянуться · S+Space — оттолкнуться<br>E — отпустить край · Shift+C — спуск с крыши<br>Ctrl — скрытность · R — возврат · Esc — меню · F3 — диагностика</small></div><div id="hint">Нажмите «Играть», чтобы захватить курсор</div><div id="diagnostics"></div><div id="animation-tools"><label>Проверка клипа <select id="clip-select"></select></label> <button id="clip-play">▶</button></div><div id="menu"><div class="panel"><h1>ParkourGame</h1><div class="muted">Тестовый уровень для проверки движения и анимаций</div><div class="row"><button id="resume">Играть</button><button id="reset">Вернуть персонажа</button></div><h2>Испытательная зона</h2><div class="row" id="zones"></div><h2>Настройки</h2><div id="settings"></div><h2>Клавиши</h2><div id="bindings"></div><h2>Ресурсы и ограничения</h2><div id="asset-info" class="muted">Загрузка модели…</div></div></div>`;
