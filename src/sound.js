export class SoundSystem {
  ...
  footsteps(dt,speed,grounded,crouch){if(!grounded||speed<.5){this.stepTime=0;return;}this.stepTime+=dt;const interval=crouch?.62:speed>3.3?.32:.52;if(this.stepTime>=interval){this.stepTime=0;this.play('step');}}
}
