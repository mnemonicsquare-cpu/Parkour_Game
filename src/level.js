...
export function createLevel(scene, world) {
  ...
  const palette = { ground: mat(0x596370), solid: mat(0x727b85), vault: mat(0xd2a55f), climb: mat(0x5eabc1), roof: mat(0x8a9caa), wall: mat(0x535865), accent: mat(0xd77369) };
  ...
  box(5, 0, -21, 7, 3, 7, 'roof', true);
  box(5, 0, -32, 7, 3.4, 7, 'roof', true);
